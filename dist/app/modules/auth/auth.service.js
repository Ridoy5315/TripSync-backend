...
const getNewAccessToken = (refreshToken) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const newAccessToken = yield (0, userTokens_1.createNewAccessTokenWithRefreshToken)(isUserExist);
    return {
...
const changePassword = (oldPassword, newPassword, decodedToken) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (!isOldPasswordMatch) {
        throw new AppError_1.default(http_status_codes_1.default.UNAUTHORIZED, "Incorrect your current password");
    }
    if (newPassword === oldPassword) {
        throw new AppError_1.default(http_status_codes_1.default.BAD_REQUEST, "You cant set the same password");
    }
    if (user) {
